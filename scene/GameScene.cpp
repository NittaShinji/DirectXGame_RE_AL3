...
void GameScene::Initialize() {
	...
	worldTransforms_[PartId::kSpine].translation_ = { 10.0f,0.5f,0.0f };
...
#pragma region 3Dオブジェクト描画
	...
	//PrimitiveDrawer::GetInstance()->DrawLine3d(startray.z, endaray.z, Vector4(256, 0, 0, 1));
